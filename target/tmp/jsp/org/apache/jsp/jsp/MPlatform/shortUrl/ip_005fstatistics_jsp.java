...
public final class ip_005fstatistics_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(\"#result\").show(\"请稍后...\");\r\n");
      out.write("\t$(\"#make\").hide();\r\n");
      out.write("\t$.getJSON(\"http://955.cc/api/statistics/\" + flag + \".json?type=all\",\r\n");
      out.write("\t\tfunction(data){\r\n");
      out.write("\t\t\tvar strHTML = \"<div>短网址编码为：\" + data.code + \"</div>\";\r\n");
      out.write("\t\t\tstrHTML += \"<div>IP数为：\" + data.data.ips + \"</div>\";\r\n");
      out.write("\t\t\tstrHTML += \"<div>点击数为：\" + data.data.clicks + \"</div>\";\r\n");
      ...
      out.write("\t<div style=\"border:0px solid red;background-image:url(/commons/image/index_main_div_titleBg.gif);height:21px;\"><img style=\"margin-left:5px;\" src=\"/commons/image/index_main_div_left.gif\" width=\"6\" height=\"2\" align=\"absmiddle\">&nbsp;<span style=\"font-weight:bold;font-size:12px;\">短网址统计</span></div>\r\n");
      ...
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<span style=\"font-size:20px;\">请输入您的短网址：</span>\r\n");
      ...
      out.write("\t\t\t<input type=\"button\" onclick=\"getShortUrl();\" value=\"开始生成\" name=\"create\"/>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
