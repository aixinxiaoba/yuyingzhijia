...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<HEAD>
		...
		<META name=description content=育婴之家庭服务为您提供专业月嫂，月嫂公司，月嫂，育儿嫂，育婴师。>
		<META name=keywords content=月嫂，月嫂公司，月嫂，月嫂公司，正规月嫂公司，育儿嫂，育婴师>
		<LINK rel="stylesheet" type="text/css"
			href="/commons/housekeeper/images/Css.css" />
		<LINK rel=stylesheet type=text/css
		...
		<link type="text/css" rel="stylesheet"
			href="/commons/easyui/easyui_user_defined.css" />
		<link type="text/css" rel="stylesheet"
			href="/commons/easyui/icon.css" />
...
<link type="text/css" href="/commons/css/common.css" rel="stylesheet" ></link>
 -->
		...
		<script type="text/javascript"
			src="/commons/js/jquery/jquery-1.7.2.min.js">
</script>
		<script type="text/javascript"
			src="/commons/easyui/jquery.easyui.min.js">
</script>
			...
			.datagrid(
					{
						...
						striped : true,
						collapsible : true,
						url : '/mpf/news/loadNewsList.do?projectKey=${param.projectKey}&menuKey=${param.projectMenuKey}',
						sortName : 'title',
						sortOrder : 'desc',
						remoteSort : false,
						idField : 'title',
						...
						frozenColumns : [ [ {
							field : 'strTitle',
							title : "&nbsp;&nbsp;<span style='font-size:13px;color:ff3300;font-weight:bold;font-family:宋体'>标题</span>",
							align : "left",
							width : fixWidth(0.6),
							formatter : function(value, rec) {
								///var strURL = "/mpf/news/newsDetial.do?newsID=" + rec.lId + "&lProjectID=${param.lProjectID}&lProjectMenuID=" + rec.lProjectMenuID;
							var strURL = "/mpf/news/newsRead.do?newsID="
									+ rec.lId
									+ "&projectKey=${param.projectKey}";
							strHTML = "<a style='color:006699;font-size:14px;font-weight: bold;font-family:宋体' href='"
									+ strURL + "'>" + rec.strTitle + "</a>";
							return strHTML;
						}
						} ] ],
						columns : [ [
						...
						{
							field : 'strSendDate',
							title : "&nbsp;&nbsp;<span style='font-size:13px;color:ff3300;font-weight:bold;font-family:宋体'>发布时间</span>",
							width : fixWidth(0.2),
							align : "center",
							formatter : function(value, rec) {
								strHTML = "<span style='color:black;font-size:12px;font-family:宋体'>"
										+ rec.strSendDate + "</span>";
								return strHTML;
							}
						} ] ],
...
function activeOrNotCustomer(lCustomerID, nType) {
	var strURL = "/mpf/customer/customerActive.do?nType="
			+ nType;
					...
					<TD vAlign=top>
						<TABLE cellSpacing=0 cellPadding=0 bgColor=#ffffff border=0>
							<TBODY>
								<TR>
									<TD
										style="BACKGROUND: url(/commons/housekeeper/images/d_top.jpg);MARGIN-TOP: 14px;padding-left: 40px;width:992px;"
										height=37>
										<span
											style='font-size: 15px; color: ff6600; font-weight: bold'
											id="menu_key"></span>
									</TD>
								</TR>
								<TR>
