...
var _myugifpath="http://log.babytree.com/rd/log.php";	// set the web path to the __myutm.gif file
...
var _myugifpath2="http://log.babytree.com/rd/log.php";

//  - document location
if (_myudl.hash) 
    _myudlh=_myudl.href.substring(_myudl.href.indexOf('#'));
if (_myudl.protocol=="https:") 
    _myugifpath2="http://log.babytree.com/rd/log.php";
if (!_myutcp || _myutcp=="") 
    _myutcp="/";
