...
<!-- rapid-validation BEGIN-->
	...
	<!-- 
	<script src="<c:url value="/scripts/rapid-validation/prototype-1.4.0.js"/>" type="text/javascript"></script>
	 	-->
	<script src="<c:url value="/scripts/rapid-validation/prototype_for_validation-debug.js"/>" type="text/javascript"></script>
