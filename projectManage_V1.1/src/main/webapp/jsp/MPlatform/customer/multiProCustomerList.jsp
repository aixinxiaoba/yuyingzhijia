...
$(function(){
	$('#customerList').datagrid({
		...
		striped: true,
		collapsible:true,
		url:'/mpf/customer/loadMultiProCustomerList.do',
		sortName: 'title',
		sortOrder: 'desc',
		remoteSort: false,
		idField:'title',
	...
	<div id="show_customer">
		...
		<div>
			<ul style="line-height: 30px;">
				<li>
					<span style="font-size:14; font-weight:bold;">多项目管理用户登陆地址：&nbsp;<%=basePath %>mpf/customer/login.do</span>
					<span><input type="button" onclick="objCore.copyData('loginUrl');" value="复制"/></span>
