...
function customerTypeDelete(lCustomerTypeID)
{
	...
	if (nCount == 0 && lCustomerTypeID <= 0)
	{
		$.messager.alert('消息提示',"<p style='font-size:14px;'>请选择您要删除的客户类型</p>", "info");
		return;
	}
...
$(function(){
	$('#customerTypeList').datagrid({
		...
		singleSelect:true,
		frozenColumns:[[
		                {field:'strName',title:"客户类型名称",align:"left",width:fixWidth(0.24),
		...
		columns:[[
			{field:'strDescrible',title:'客户类型描述',width:fixWidth(0.24),align:"center"},
		...
		},
		{
			...
			handler:function(){
				...
				if (row == null)
				{
					$.messager.alert('消息提示',"<p style='font-size:14px;'>请选择您要修改的客户类型！</p>", "info");
					return;
				}
				$("#index_main_div1").hide();
		...
		},
		{
			...
			iconCls:'icon-edit',
			handler:function(){
				location.href = "/jsp/MPlatform/project/operCustomerTypeAndFiledInfo.jsp?lProjectID=${param.lProjectID}";
			}
		}
		]
	});
...
<div id="index_main_div1" style="background-color:#f7fbfc;margin-top:0px;margin-left:3px;min-height:500px;">
	<div style="border:0px solid red;background-image:url(/commons/image/index_main_div_titleBg.gif);height:21px;"><img style="margin-left:5px;" src="/commons/image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">客户类型列表</span></div>
...
<div id="index_main_div2" style="background-color:#f7fbfc;margin-top:0px;margin-left:3px;min-height:500px;display:none;">
	<div style="border:0px solid red;background-image:url(/commons/image/index_main_div_titleBg.gif);height:21px;"><img style="margin-left:5px;" src="/commons/image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;" id="info_title">新增客户类型</span></div>
	<div id="oper_modify">
