...
<BODY class="bg_1">
	<div>
		<DIV class="nav_header_wrap_fix">
			<A class="nav_header_right" href="/static/m/nav.html"><IMG src="/m/common/gm/header_nav_btn.png"></A>
		...
		<DIV class="contentWrapper_fix">
						...
						<UL class="news_list" style="display: block;" id="newstList_s">
							<li>
							  <#if objUpNews??>
									...
									<A class="list_title_l" style="padding-left:0px;" href="/static/news/${objUpNews.lId?string('###')}">
							...
							<li>
								...
								<#if objNextNews??>
									<A class="list_title_l" style="padding-left:0px;" href="/static/news/${objNextNews.lId?string('###')}">
										${objNextNews.strFormatTitle }</A>
								<#else>
									<span style="font-size:14px;">已经没有喽！</span>
								</#if>
							</li>
						</UL>
			...
			<DIV class="bar_nav">
				<DIV class="bar_nav_main"  style="font-size:16px;">
					<a>最新动态<span style="font-size:14px;">（知识早知道，育儿无烦恼）</span></a>
				</DIV>
			</DIV>
			<DIV class="boxcontent">
				<!-- 热点排行-->
			...
			<!-- search <DIV class="mainlistsbox" style="margin: 10px 0px 0px;">
