...
<body>
	<div id="content">
		<header>
			<div id="head-nav">
				<span class="title">知识搜索</span>
				<a class="back" href="javascript:history.back();"></a>
				<a class="index" href="/front/m/index.do" onclick="JLOG({'id':'N00006','l':4});"></a>
			</div>
			<div class="box" id="headbox">
				<form class="searchbox fill_query" action="/front/m/newsSearch.do" method="get">
					<span class="txt"> 
						<input name="searchText" type="text" value="${searchText }" autocomplete="off" maxlength="60" placeholder="">
						<input type="hidden" name="by" value="submit">
						<div class="btn_clear"></div>
					</span>
					<input type="hidden" name="uc_param_str" value="dnntnwvepffrgibijbprsvpi">
					<label class="split"></label>
					<label for="btn-submit" class="lbtn"></label>
					<input type="submit" id="btn-submit" class="btn btn-submit" value="搜新闻">
					<div class="suggest" style="display: none; top: 36px;">
						<div class="box"></div>
					</div>
				</form>
			</div>
		</header>
		<div id="results" data-total="11">
			<s:if test="objGPagination != null && objGPagination.rows.size > 0">
            	<s:iterator value="objGPagination.rows" id="news" status="mystatus">
					<a class="result card box"
						href="/front/yuyingshi/detail.do?lProjectMenuID=${news.objProjectMenu.objParentProjectMenu.lId }&newsID=${news.lId}">
						<div
							class="flexbox">
							<h2>
								${news.strLongTitle }
								<!-- 
								查询结果标注红色显示。
								<em>杜海涛</em>自拍惊呆网友 瘦身成功五官立体<em>变型男</em>(图)
								 -->
							</h2>
							<div class="tail">
								<span class="host">育婴之家</span><span class="time">${news.strSendDate}<!-- 9小时前 --></span>
							</div>
						</div>
						<!-- 
						如有查询结果中存在图片 则打开注释。
						<div class="img">
							<img src="http://s2.zimgs.cn/ims?kt=url&amp;at=news&amp;key=aHR0cDovL2ltZzEuZHp3d3cuY29tOjgwODAvdHVwaWFuX3BsLzIwMTUwNjEzLzg2LzU3ODAyNDExNTM1MTc4NzgxMTQuanBn&amp;sign=yx:rK-DZb85ZoVDEYYZGjmSOLF5lRQ&amp;tv=150_150&amp;x.jpg"
								onload="img_onload(this)"
								style="max-width: 100%; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;">
						</div>
						 -->
					</a>
				</s:iterator>
		...
		<div class="rel-news">
			...
			<ul>
				<li><a
					href="http://m.sm.cn/news?q=%E6%9D%9C%E6%B5%B7%E6%B6%9B%E8%B7%91%E7%94%B7&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':1,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">杜海涛跑男</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E8%83%96%E5%AD%90%E5%8F%91%E5%9E%8B%E7%94%B7+%E6%9D%9C%E6%B5%B7%E6%B6%9B&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':2,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">胖子发型男
						杜海涛</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E6%9D%9C%E6%B5%B7%E6%B6%9B%E8%AE%BD%E5%88%BA%E8%B7%91%E7%94%B7&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':3,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">杜海涛讽刺跑男</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E6%9D%9C%E6%B5%B7%E6%B6%9B%E7%9C%9F%E7%94%B7&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':4,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">杜海涛真男</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%A5%BD%E7%9C%9F%E7%94%B7&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':5,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">杜海涛好真男</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E6%9D%9C%E6%B5%B7%E6%B6%9B%E6%94%BB%E5%87%BB%E8%B7%91%E7%94%B7&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':6,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">杜海涛攻击跑男</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E7%9C%9F%E7%94%B7+%E6%9D%9C%E6%B5%B7%E6%B6%9B%E8%82%A5%E8%82%89%E6%97%A0%E5%A4%84%E9%81%81%E5%BD%A2&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':7,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">真男
						杜海涛肥肉无处遁形</a></li>
				<li><a
					href="http://m.sm.cn/news?q=%E7%94%B7%E7%A5%9E%E6%9D%9C%E6%B5%B7%E6%B6%9B&amp;by=relative&amp;uc_param_str=dnntnwvepffrgibijbprsvpi"
					onclick="return JLOG({'id':'N00013','ps':8,'l':4,'by':'relative','q':this.innerText,'oq':'%E6%9D%9C%E6%B5%B7%E6%B6%9B%E5%8F%98%E5%9E%8B%E7%94%B7'},this);">男神杜海涛</a></li>
			</ul>
		</div>
		 -->
		<div class="backTop">
		...
		<footer>
			<div class="box" id="footbox">
				<form class="searchbox fill_query" action="/front/m/newsSearch.do" method="get" name="nextForm">
					<span class="txt"> 
						<input name="searchText" type="text" value="${searchText }" autocomplete="off" maxlength="60" placeholder="">
						<input type="hidden" name="by" value="submit">
						<div class="btn_clear"></div>
					...
					<label class="split"></label>
					<label for="btn-submit" class="lbtn"></label>
					<input type="button" id="btn-submit" class="btn btn-submit" value="搜新闻" onclick="nextForm.submit();">
					<div class="suggest" style="display: none; top: 36px;">
						<div class="box"></div>
					</div>
				</form>
			...
			<div id="footnote">
				<a class="home"
					href="/front/m/index.do">新闻首页</a><br>
				<br>
			</div>
		</footer>
	</div>
