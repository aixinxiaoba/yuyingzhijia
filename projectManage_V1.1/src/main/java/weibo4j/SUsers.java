...
public class SUsers extends Weibo {

	private static final long serialVersionUID = 4742830953302255953L;

	public SUsers(String access_token) {
	 ...
	 * @since JDK 1.5
	 */
	public SUser showUserById(String uid) throws WeiboException {
		return new SUser(client.get(
	 ...
	 * @since JDK 1.5
	 */
	public SUser showUserByScreenName(String screen_name) throws WeiboException {
		return new SUser(client.get(
				WeiboConfig.getValue("baseURL") + "users/show.json",
	 ...
	 * @since JDK 1.5
	 */
	public SUser showUserByDomain(String domain) throws WeiboException {
		return new SUser(client.get(
