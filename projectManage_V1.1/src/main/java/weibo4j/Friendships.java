...
public class Friendships extends Weibo {
	...
	public UserWapper getFriendsByID(String id) throws WeiboException {
		return SUser.constructWapperUsers(client.get(
	...
	public String[] getFriendsBilateralIds(String uid) throws WeiboException {
		return SUser.constructIds(client.get(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public SUser createFriendshipsById(String uid) throws WeiboException {
		return new SUser(client.post(
	 ...
	 * @since JDK 1.5
	 */
	public SUser createFriendshipsByName(String screen_name)
			throws WeiboException {
		return new SUser(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/create.json",
				new PostParameter[] { new PostParameter("screen_name",
	 ...
	 * @since JDK 1.5
	 */
	public SUser createFriendships(Map<String, String> map)
			throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return new SUser(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/create.json",
	 ...
	 * @since JDK 1.5
	 */
	public SUser destroyFriendshipsById(String uid) throws WeiboException {
		return new SUser(client.post(
	 ...
	 * @since JDK 1.5
	 */
	public SUser destroyFriendshipsByName(String screen_name)
			throws WeiboException {
		return new SUser(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/destroy.json",
				new PostParameter[] { new PostParameter("screen_name",
