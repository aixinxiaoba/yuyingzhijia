...
<body>
    <div class="Main">
        <ul>
            ...
            <li class="topC"></li>
            <li class="topD">
<%--            	<s:form action="usersLogin.do" method="post">--%>
            	<form action="/login/usersLogin.do" method="post" name="login" id="login">
	                <ul class="login">
	                	<li>
	                    ...
	                    <li>
	                    	...
	                    	<span style="left">
	                        	<input id="Text1" type="text" class="txt" name="strUsername" value="${strCustomerName}" onkeydown="if(event.keyCode==32) return false"/>
	                    	</span>
