...
TY.m.nav = function($) {
    ...
    function initDom() {
        if (Conf.showTopNav) {
            ...
            var t = location.href,
            n = ['<li class="item menu ' + (Conf.navOpen ? "": "active") + '" id="ty_menu"  ><i class="nav-down"></i></li>', isOnline ? '<li id="nav_user" class="item avatar ' + (Conf.navOpen ? "active": "") + '" ><a href="http://www.tianya.cn/m/my.jsp?comeURL=' + t + '"><img alt="å¤´åƒ" src="http://tx.tianyaui.com/logo/small/' + userId + '"></a></li>': '<li class="item ' + (Conf.navOpen ? "active": "") + '"><a href="http://passport.tianya.cn/login_m.jsp?fowardURL=' + t + '">ç™»å½•</a></li>'].join("");
    ...
    function initEvent() {
        ...
        function() {
            ...
            i ? (c.show(), c.addClass("show"), e.height(r), o.css({
                position: "absolute"
            }), Conf.clickDom2Hide && (e.height($("body").height()), e.show()), Conf.showHideIcon && s.show(), "undefined" != typeof BBSMain && BBSMain.clickStat && BBSMain.clickStat("å¯¼èˆªå±•å¼€")) : (c.removeClass("show"), Conf.showHideIcon && setTimeout(function() {
                s.hide()
            },
        ...
        function() {
            var t = $(this);
            "undefined" != typeof BBSMain && BBSMain.clickStat && BBSMain.clickStat("å¯¼èˆª-" + t.html())
        }),
    ...
    htmlTpl = ['<div class="ty-m-nav">', '<header class="m-header" id="j-header">', '<div class="m-bar f-cf">', '<ul class="m-bar-left" id="ty_go_back">', '<li class="a">', '<a href="{goBackUrl}" class="icon-back"></a>', "</li>", "</ul>", '<ul class="m-bar-center" id="ty_logo">', '<li class="logo">', '<a href="http://www.tianya.cn/m/" class="logo-img"><span class="f-vh">å¤©æ¶¯ç¤¾åŒº</span></a>{title}', "</li>", "</ul>", '<ul class="m-bar-right user-info"></ul>', "</div>", "</header>", '<nav class="m-nav "  id="ty_nav" >', '<div class="nav-wrap {showNav}">', "</div>", "</nav>", '<div class="nav-mask" id="nav_mask"></div>', "</div>"].join(""),
    navsTpl = ['<div class="m-nav-row">', '<a class="active" href="http://www.tianya.cn/m/" appstr="shouye">é¦–é¡µ</a>',
               '<a href="http://bbs.tianya.cn/m/block.jsp" appstr="bbs">ç‰ˆå—</a>',
               '<a href="http://focus.tianya.cn/g" appstr="focus">èšç„¦</a>', '<a href="http://groups.tianya.cn/" appstr="groups">éƒ¨è½</a>',
               '<a href="http://blog.tianya.cn/m/" appstr="blog">åšå®¢</a>', "</div>", '<div class="m-nav-row">', 
               '<a href="http://wenda.tianya.cn/m/" appstr="wenda">é—®ç­”</a>', '<a href="http://book.tianya.cn/m/" appstr="ebook">æ–‡å­¦</a>', 
               '<a href="http://yy.tianya.cn/" appstr="game">æ¸¸æˆ</a>', '<a href="http://nong.tianya.cn/m/" appstr="food">å†œåœº</a>',
               '<a href="http://shang.tianya.cn/rank/m/dsRanking.do?from=t&type=1" appstr="shang">æ‰“èµ</a>', "</div>", 
               '<div class="nav-up" style="display:none;" id="nav_up">æ”¶èµ·</div>'].join(""),
    footTpl = ['<div class="ty-m-foot">', '<div class="m-pc">', '<a href="http://www.tianya.cn/m/">è§¦å±ç‰ˆ</a>', '<a href="http://www.tianya.cn/login.html" id="j-to-web">ç”µè„‘ç‰ˆ</a>', "</div>", '<div class="copyright">', '<a target="_blank" href="http://service.tianya.cn/m/html/index.html" id="j-feedback">ç»™å¤©æ¶¯æå»ºè®®</a>', "<small>tianya.cn  ç¼B2-20060032</small>", "</div>", "</div>"].join(""),
    pre = "ty-m-nav",
...
BBSMain.QucickFun = function(t) {
    ...
    o = {
        tpl: ['<li><a href="#" class="i-top"><span>é¡µå¤´</span></a></li>', '<li><a href="http://search.tianya.cn/m/bbs.jsp?backUrl=' + location.href + '" class="i-search"><span>æœç´¢</span></a></li>', '<li><a href="#js-footer" class="i-tail"><span>é¡µå°¾</span></a></li>', '<li><a href="http://bbs.tianya.cn/m/my_trace_list.jsp" class="i-history"><span>è¶³è¿¹</span></a></li>'].join(""),
        firstFunc: function() {},
        openCbk: function() {}
    };
    $.extend(o, t),
...
BBSMain.showLoginTips = function(t, n, a, i) {
    ...
    a = a || "ç™»å½•" == n ? '<label><input type="checkBox" id="login_tip_nomore" />ä¸å†æç¤º</label>': "æ­¤åŠŸèƒ½éœ€ç™»å½•æ‰èƒ½ä½¿ç”¨å“¦~", __global.isOnline() || !t()) return ! 1;
    ...
    h.find(".login").click(function() {
        BBSMain.clickStat(n + "æç¤º-ç™»å½•")
    }),
    h.find(".login").click(function() {
        BBSMain.clickStat(n + "æç¤º-ç™»å½•")
    }),
    h.find(".regist").click(function() {
        BBSMain.clickStat(n + "æç¤º-æ³¨å†Œ")
    }),
