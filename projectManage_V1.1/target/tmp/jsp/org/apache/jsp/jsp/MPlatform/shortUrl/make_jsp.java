...
public final class make_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(\"#result\").show(\"请稍后...\");\r\n");
      out.write("\t$(\"#make\").hide();\r\n");
      out.write("\t$.getJSON('http://955.cc/short/?url=' + encodeURIComponent($(\"#myUrl\").val()) + '&format=jsonp&callback=?',\r\n");
      out.write("\t\tfunction(data){\r\n");
      out.write("\t\t\tif(data.errno == 0)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tvar strHTML = \"<div>制作成功，您的短网址为：\" + data.url + \" 请牢记！！！</div>\";\r\n");
      out.write("\t\t\t\t// 生成二维码。\r\n");
      out.write("\t\t\t\tstrHTML += \"<div style='margin-top:20px;'>二维码为：<img src='\" + data.url + \".qr'></div>\";\r\n");
      ...
      out.write("\t<div style=\"border:0px solid red;background-image:url(/commons/image/index_main_div_titleBg.gif);height:21px;\"><img style=\"margin-left:5px;\" src=\"/commons/image/index_main_div_left.gif\" width=\"6\" height=\"2\" align=\"absmiddle\">&nbsp;<span style=\"font-weight:bold;font-size:12px;\">短网址制作</span></div>\r\n");
      ...
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<span style=\"font-size:20px;\">请输入你要缩短的网址：</span>\r\n");
