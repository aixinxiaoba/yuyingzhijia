...
public interface BaseDao<E>
{
     ...
     * @return
     */
    public boolean save(E objEntity);
     ...
     * @return
     */
    public boolean saveOrUpdate(E objEntity);
     ...
     * @return
     */
    public boolean deleteByCriteria(SimpleExpression objOne, SimpleExpression objTwo);
     ...
     * @return
     */
    public boolean delete(E objEntity);
     ...
     * @return
     */
    public boolean deleteByProps(E objEntity, String strUniquePropertyNames);
     ...
     * @return
     */
    public boolean update(E objEntity);
...
//     * @return
//     */
//    public List<E> listByCriteria(Pagination objPagination, long start, long pagesize, SimpleExpression objOne, SimpleExpression objTwo);
     ...
     * @return
     */
    public List<E> listByCriteria(Pagination<E> objPagination, SearchCondition objCondition, Order objOrder);
    ...
    public abstract List<E> listBySQL(Pagination<E> paramPagination, String paramString);
