...
<body>
	<header class="topbar">
		...
		<span class="t-back"><a href="/static/m/index.html" class="icon-back"></a></span>
	</header>
			...
			<div class="sm-item" id="smi_1">
				...
				<ul class="ulnav float-no">
					<#list projectMenu.lstChildrenProjectMenu as subProjectMenu>
						<li><a href='/front/m/newsList.do?lProjectMenuID=${projectMenu.lId}&menuID=${subProjectMenu.lId}'>${subProjectMenu.mobileMenuName }</a></li>
					</#list>
				</ul>
			</div>
		</#list>
