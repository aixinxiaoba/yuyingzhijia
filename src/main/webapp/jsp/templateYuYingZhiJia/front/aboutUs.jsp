							...
							<TBODY>
								<TR>
									<TD style="BACKGROUND: url(/commons/housekeeper/images/d_top.jpg);MARGIN-TOP: 14px;padding-left: 40px;width:992px;" height=37>
										<span style='font-size:15px;color:ff6600;font-weight: bold'>关于我们</span>
									</TD>
								</TR>
								<TR>
									<TD vAlign=top style="line-height:22px">
										<TABLE style="MARGIN-BOTTOM: 30px; MARGIN-TOP: 30px;color:ff6600;"
											cellSpacing=0 cellPadding=0 width="85%" align=center border=0>
											<TBODY>
												<TR>
													<TD>
														<ul style="line-height: 30px;font-weight: bold;">
															<li style="font-size:20px;">我们是一个刚起步的育婴信息服务网站</li>
															<li style="font-size:20px;">育婴知识传播/分享 寻找工作 学习充电等信息服务！</li>
															<li style="font-size:20px;">育英之家团队真情欢迎您的加入！ </li>
														</ul>
													</TD>
												</TR>
											</TBODY>
