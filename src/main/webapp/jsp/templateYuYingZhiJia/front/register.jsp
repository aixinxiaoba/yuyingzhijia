		...
		frozenColumns:[[
		    {field:'strTitle',title:"&nbsp;&nbsp;<span style='font-size:13px;color:ff3300;font-weight:bold;font-family:宋体'>标题</span>",align:"left",width:fixWidth(0.6),
				formatter:function(value,rec)
				{
		    		...
		    		var strURL = "/mpf/news/newsRead.do?newsID=" + rec.lId + "&projectKey=${param.projectKey}";
		    		strHTML = "<a style='color:006699;font-size:14px;font-weight: bold;font-family:宋体' href='" + strURL + "'>"+rec.strTitle+"</a>";
					return strHTML;
				}
			}
		    ]],
