...
<DIV class="navi-head" id="navi-head" name="navi-head">
	<DIV class="navi-con-block">
		<DIV class="navi-left">
			...
			<%--
			<!--
			<A class="page-title-pic" id="page-title" href="/"></A>
		...
		<div class="navi-right">
			<div id="needLogin" style="margin-top:4px;display:none;">
			    ...
			    <!-- 新浪微博 关注按钮  -->
				 <a href="javascript:void(0);" target="_self" class="head-login re-lo-style black" style="margin-left:12px;text-decoration:none;font-size:16px;letter-spacing:1px"><wb:follow-button uid="2895295707" type="red_1" /></a>
			     <a href="https://api.weibo.com/oauth2/authorize?client_id=4148667325&redirect_uri=http://www.yuyingzhijia.cn/login/sinaLogin.do&response_type=code" class="weibo-sina link-icon-style" title="使用新浪微博登陆"></a>
				 <!-- 
				 qq登陆
